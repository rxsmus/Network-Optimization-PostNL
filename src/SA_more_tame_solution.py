...
def calculate_yearly_cost_final(demand_data, allocations):
    ...
    std_dev_percentage = 50.0586532 / 100
...
def add_service_point(nodes, service_points):
    ...
    eligible_nodes = [753, 3343, 1934, 5820, 4356, 1739,
                  7859, 2155, 5706, 3513, 4431, 1204, 718, 657, 4387,
                  2075, 931, 417, 284, 6765, 3921, 7229, 4354, 8282, 2096, 1176,
                  7422, 4987, 5499, 1258, 4440, 3155, 1026, 6908, 1379]

    # Randomly select a node from the eligible nodes
    new_service_point = random.choice(eligible_nodes)

    # Check if the new service point is already in the service points
    while new_service_point in service_points:
        new_service_point = random.choice(eligible_nodes)
...
service_points = [753, 3343, 1934, 5820, 4356, 1739,
                  7859, 2155, 5706, 3513, 4431, 1204, 718, 657, 4387,
                  2075, 931, 417, 284, 3921, 7229, 4354, 8282, 2096, 1176,
                  4987, 5499, 1258, 4440, 3155, 1026, 6908, 1379] # intilaized existing situation - removed 7422 and 6765 as they are clearly by far the two worst
...
add_prob = 0.2 #made adding less probable,
